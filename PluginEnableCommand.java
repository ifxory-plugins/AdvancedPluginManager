...
public class PluginEnableCommand implements CommandExecutor {

	public PluginEnableCommand(AdvancedPluginManager advancedPluginManager) {
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(Bukkit.getPluginManager().isPluginEnabled(args[0])) {
			sender.sendMessage(ChatColor.RED + "Logic error. Cannot perform this with enabled plugin.");
			return true;
		}
